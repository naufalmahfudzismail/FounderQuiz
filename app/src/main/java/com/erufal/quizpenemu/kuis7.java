...
public class kuis7 extends AppCompatActivity {
    ...
    String kelas;
    String nim;
    String soal1, soal2, soal3, soal4, soal5, soal6;
    private int score = 0;
    int score2;
    Button btn1;
    Button btn2;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if(keyCode==KeyEvent.KEYCODE_BACK) {
            ...
            Toast.makeText(getApplicationContext(),"Kamu tak bisa kembali ke soal 7",Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Soal 7");
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(kuis7.this, kuis8.class);
                ...
                intent.putExtra("Soal7", "A (Benar)(+4)");
                intent.putExtra("Score",score2 + 4);
                Toast.makeText(getApplicationContext(),"Masuk ke soal 8",Toast.LENGTH_SHORT).show();
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Soal5", soal5);
                intent.putExtra("Soal6", soal6);
                intent.putExtra("Soal7", "B (Salah)(-1)");
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Soal5", soal5);
                intent.putExtra("Soal6", soal6);
                intent.putExtra("Soal7", "C (Salah)(-1)");
                intent.putExtra("Score",score2-1);
                Toast.makeText(getApplicationContext(),"Masuk ke soal 8",Toast.LENGTH_SHORT).show();
                startActivity(intent);
            }
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Soal5", soal5);
                intent.putExtra("Soal6", soal6);
                intent.putExtra("Soal7", "D (Salah)(-1)");
                intent.putExtra("Score",score2-1);
                Toast.makeText(getApplicationContext(),"Masuk ke soal 8",Toast.LENGTH_SHORT).show();
                startActivity(intent);
            }
